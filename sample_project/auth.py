...
class AuthService:
    """This is function inside authService Handles login and basic access control."""
    ...
    def register(self, username: str, email: str, password: str) -> User:
        """This is function inside authService  Create a new user. Raises AuthError if email already exists."""
    ...
    def login(self, email: str, password: str) -> str:
        """
        This is function inside authService 
    ...
    def get_current_user(self, token: str) -> User:
        """This is function inside authService  Resolve a session token to a User. Raises AuthError if invalid."""
    ...
    def logout(self, token: str) -> None:
        """This is function inside authService  Invalidate a session token."""
